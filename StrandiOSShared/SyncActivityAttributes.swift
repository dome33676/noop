...
///
/// A SEPARATE activity type from `NOOPActivityAttributes` (live HR): a different question with a
/// different lifetime. It lives from the moment a sync is asked for until a few seconds after it ends.
/// While it is showing, the app suppresses the live-HR activity rather than stacking two banners.
///
